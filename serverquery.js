...
// //         io.to(roomName).emit('updateHands', rooms[roomName].raisedHands); // Update hands list
...
// //         if (player && !rooms[roomName].raisedHands.includes(player.name)) {
// //             rooms[roomName].raisedHands.push(player.name);
// //             io.to(roomName).emit('updateHands', rooms[roomName].raisedHands);
// //         }
// //     });
...
// //         const player = rooms[roomName].players.find(p => p.id === socket.id);
// //         if (player) {
// //             rooms[roomName].raisedHands = rooms[roomName].raisedHands.filter(name => name !== player.name);
// //             io.to(roomName).emit('updateHands', rooms[roomName].raisedHands);
// //         }
// //     });
...
// //     //         rooms[roomName].raisedHands = rooms[roomName].raisedHands.filter(name => name !== socket.id);
...
// //                 rooms[roomName].raisedHands = rooms[roomName].raisedHands.filter(name => name !== playerName);
